...
const ContactDetails = () => {
  return (
    <div className="ml-[4%] pt-8 md-768:ml-[20%]">
      ...
      <div className="relative h-[14rem] w-[95%] animate-gradient-xy rounded-2xl border bg-gradient-to-r from-rose-200 to-amber-300 p-6 dark:from-fuchsia-700 dark:to-sky-800 md-768:h-[17rem] md-768:w-[85%]">
        <div className="grid h-full grid-rows-2">
          <div>
            <h3 className="text-base md-768:text-xl">Email</h3>
            <Snippet className="bg-transparent text-base md-768:text-xl">
              sagarvaish2823@gmail.com
            </Snippet>
          </div>
          <div className="flex h-full items-end justify-start">
            <div>
              <h2 className="text-base md-768:text-xl">SAGAR VAISH</h2>
              <h3 className="text-sm text-gray-300">websitesbysagar</h3>
            </div>
          </div>
        </div>
        <div className="absolute bottom-0 right-4">
          <div className="relative aspect-square w-[7rem] md-768:w-[10rem]">
